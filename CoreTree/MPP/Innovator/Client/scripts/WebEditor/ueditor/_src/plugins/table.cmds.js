            ...
            function createTable(opt, tdWidth) {
                ...
                for (var r = 0; r < rowsNum; r++) {
                    ...
                    for (var c = 0; c < colsNum; c++) {
                        //Modify by tengz 2019/7/3 MPP
						//默认加上边框
                        //html.push('<td width="' + tdWidth + '"  vAlign="' + opt.tdvalign + '" >' + (browser.ie && browser.version < 11 ? domUtils.fillChar : '<br/>') + '</td>')
						html.push('<td style="border-width: 1px; border-style: solid;" width="' + tdWidth + '"  vAlign="' + opt.tdvalign + '" >' + (browser.ie && browser.version < 11 ? domUtils.fillChar : '<br/>') + '</td>')
                    }
                    html.push('</tr>')
                }
                //禁止指定table-width
				//Modify by tengz 2019/7/5 MPP
				//为table添加样式,取消单元格边距
