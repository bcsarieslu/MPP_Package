...
UE.I18N['zt'] = {
    'labelMap':{
        ...
        'music':'音樂','inserttable':'插入表格','drafts': '從草稿箱加載', 'charts': '圖表','bcsInsertRowORText':'文本模式插入對象','bcsAdd2Template':'添加至模板','bcsImportExcel':'導入Excel模板',
        'bcsInsertGraphicImage':'插入Graphic','bcsInsertImage':'上傳圖片','bcsConfigColumns':'設置插入對象屬性','bcsLoadOtherLanguageSOP':'載入其它語系SOP'
    },
    'insertorderedlist':{
        'num':'1,2,3...',
        'num1':'1),2),3)...',
